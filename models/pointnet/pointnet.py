...
import sys
sys.path.append('..')
from models.pointnet.pointnet2.pointnet2_modules import PointnetFPModule, PointnetSAModuleMSG
import models.pointnet.pointnet2.pytorch_utils as pt_utils
